...
export const getCart = async (req,res) => {
    try {
        ...
        const cleanedItems = cart.items.filter((item) => item.productId !== null);
...
export const updateQuantity = async (req, res) => {
    try {
        ...
        cart.totalPrice = cart.items.reduce((acc, item) => acc + item.price * item.quantity, 0) // 0 -> acc initial value
